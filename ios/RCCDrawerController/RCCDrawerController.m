...
-(void)drawerStateChange {
    ...
    printf(@"side");
    [[[RCCManager sharedInstance] getBridge].eventDispatcher sendAppEventWithName:@"drawerState" body:@
        {
            @"side": side
        }];
}
...
- (void)performAction:(NSString*)performAction actionParams:(NSDictionary*)actionParams bridge:(RCTBridge *)bridge
{
    ...
    {
        [super toggleDrawerSide:side animated:animated completion:^(BOOL finished) {
            [self drawerStateChange];
        }];
        return;
    }
